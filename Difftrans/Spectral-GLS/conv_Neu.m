...
alpha = -1;
for i = 1:length(N)
	[e1(i) cn] = runMain_Spec_Neudir(N(i),mu,alpha); % Spectral
	[e2(i) cn] = runMain_LS_Neudir(N(i),mu,alpha); % Spectral LS regular
...
saveas(fig1, '../../Latex/Figures/Spec_difftrans_Convergence_Neu', 'pdf') %Save figure
